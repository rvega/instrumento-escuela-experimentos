...
(function(global){
   ...
   /** 
    * @constructor AudioInstrumentoChime
    */
   var AudioInstrumentoChime = function(params){
      var p = params || {};
       ...
       * @private
       */
      this.descarga = p.descarga || 0.800;
   ...
   EscuelaDeExperimentos.Utility.mixin(AudioInstrumentoChime.prototype, EscuelaDeExperimentos.AudioMixinInstrumentoMonofonico);
    ...
    * @method tocarNota
    */
   AudioInstrumentoChime.prototype.tocarNota = function(tiempo, duracion, cualNota){
      if(cualNota === -1){
         return;
      }
   ...
   AudioInstrumentoChime.prototype.getGain = function(){
      if(this.gain===null){
         return 0;
      }
   ...
   global.EscuelaDeExperimentos.AudioInstrumentoChime = AudioInstrumentoChime;
})(this);
